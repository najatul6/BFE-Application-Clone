...
class Registration(PwebModel):
    name = pweb_orm.Column("name", pweb_orm.String(150), nullable=False)
    mobile = pweb_orm.Column("mobile", pweb_orm.Integer(), nullable=False)
    emergencyContact = pweb_orm.Column("emergencyContact", pweb_orm.Integer(), nullable=False)
